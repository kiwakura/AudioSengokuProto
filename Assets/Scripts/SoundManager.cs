...
public class SoundManager : SingletonMonoBehaviour< SoundManager > {
    ...
    {
        return PlaySe( GetSeIndex( name ), 1.0f, 0f );
    }
	public Handle PlaySeVol( string name, float vol )
    {
        return PlaySe( GetSeIndex( name ), vol, 0f );
    }
	public Handle PlaySeVolPan( string name, float vol, float pan )
    {
        return PlaySe( GetSeIndex( name ), vol, pan );
    }
   
	//------------------------------------------------------------------------------
	public Handle PlaySe( int index, float vol, float pan )
    {
